...
with open("benchmark_100_100.txt", "r") as ifile:  
    ...
    best_length, best_items = genetic_algorithm(items, bin_capacity, 50, 50, 2, 0.7, 0.3, 0.4, 'FF',False, 'TS')

    end_time = time.time()
    execution_time = end_time - start_time

    print(f"")
    print(f"Best solution length: {best_length}")
    print(f"")
    print("Best solution bins objects: ", best_items)
    print(f"")
